...
<head>
  ...
  <title>Admin Login — BOOK HUB</title>
  ...
  <link rel="stylesheet" href="/book-hub/public/static/css/auth.css">
  <link rel="stylesheet" href="/book-hub/public/static/css/admin-login.css">
</head>
<body class="admin-login-page">
    ...
    <div class="auth-wrapper">
      ...
      <div class="auth-image admin-image">
        ...
        <div class="auth-content">
          ...
          <p>Manage your BOOK HUB platform with advanced administrative tools</p>
      ...
      <div class="auth-form-container">
        <div class="auth-form-wrapper">
          <!-- Back to Site Link -->
          <a href="/book-hub/public/index.php" class="back-to-site">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <form class="auth-form" id="admin-login-form" action="/book-hub/src/handlers/admin-login-handler.php" method="POST">
            <div class="form-group">
              ...
              <div class="input-with-icon">
                ...
                <input type="email" id="admin-email" name="email" placeholder="admin@bookhub.com" required>
              </div>
            </div>
            ...
            <div class="form-options">
              ...
              <a href="#" class="forgot-password">Request Access</a>
            </div>
          ...
          <div class="auth-footer admin-footer">
            <p>Need help? <a href="/book-hub/public/contact.php">Contact Support</a></p>
  ...
  <script src="/book-hub/public/static/js/admin-login.js"></script>
