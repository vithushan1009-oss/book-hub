...
<head>
  ...
  <title>Admin Registration — BOOK HUB</title>
    ...
    <div class="auth-wrapper">
      ...
      <div class="auth-form-container">
        <div class="auth-form-wrapper">
          ...
          <form class="auth-form" id="admin-register-form" action="/book-hub/src/handlers/admin-register-handler.php" method="POST">
