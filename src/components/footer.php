  ...
  <div class="container">
    <div class="footer-grid">
      ...
      <div class="footer-section">
        ...
        <p>Your gateway to endless stories. Rent physical books or buy digital editions instantly.</p>
      ...
      <div class="footer-section">
        <h3>Services</h3>
        <ul>
          <li>Physical Book Rental</li>
          <li>Digital Book Purchase</li>
      ...
      <div class="footer-section">
        ...
        <ul>
          <li>
            ...
            <span>45 Stanley Road, Jaffna 40000, Sri Lanka</span>
          </li>
          <li>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
