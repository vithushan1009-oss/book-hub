...
if($cover_image && $pdf_file) {
    ...
    $stmt->bind_param("ssssssidsssssssssi", $title, $author, $isbn, $genre, $description, $book_type, $total_quantity, $rental_price_per_day, $purchase_price, $cover_image, $cover_image_type, $pdf_file, $pdf_file_name, $pdf_file_size, $pdf_file_type, $publisher, $publication_date, $admin_id);
} elseif($cover_image) {
    ...
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssssidsssssi", $title, $author, $isbn, $genre, $description, $book_type, $total_quantity, $rental_price_per_day, $purchase_price, $cover_image, $cover_image_type, $publisher, $publication_date, $admin_id);
} elseif($pdf_file) {
    ...
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssssidsssssssi", $title, $author, $isbn, $genre, $description, $book_type, $total_quantity, $rental_price_per_day, $purchase_price, $pdf_file, $pdf_file_name, $pdf_file_size, $pdf_file_type, $publisher, $publication_date, $admin_id);
} else {
    ...
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssssidssssi", $title, $author, $isbn, $genre, $description, $book_type, $total_quantity, $rental_price_per_day, $purchase_price, $publisher, $publication_date, $admin_id);
}
