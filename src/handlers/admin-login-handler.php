...
if ($result->num_rows == 0) {
    ...
    header('Location: /BOOKHUB/book-hub-central/public/admin-login.html?error=' . urlencode('Invalid credentials'));
    exit();
}
...
header('Location: /BOOKHUB/book-hub-central/src/views/admin.php');
exit();
